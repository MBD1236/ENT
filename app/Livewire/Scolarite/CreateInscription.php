...
class CreateInscription extends Component
{
     ...
     * qu'on fait appel aux informations de l'etudiant à inscrire ou à reinscrire comme
     * (son nom, son prenom...)
     *
     * @var Etudiant
     */
    ...
    public function store()
    {
        ...
        if (!is_string($this->photo)) {
            ...
            return redirect()->route('scolarite.inscription.index');
    }
     ...
     * ce composant s'etend du composant scolarite
     *
     * @return view
     */
    ...
    public function render()
    {
        ...
        return view('livewire.scolarite.create-inscription',[
