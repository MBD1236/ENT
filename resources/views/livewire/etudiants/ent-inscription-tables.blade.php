<div class="pagetitle">
    <div class="pagetitle text-center pge">
        <h1>Bienvenue au formulaire de réinscription </h1>
                ...
                <div class="col-4 d-lg-block ">
                    <form action="" wire:submit.prevent='init'>
                        <div class="input-group"> 
                            <input wire:model="searchIne" type="search" class="form-control" placeholder="Enter your (ine/matricule) here">
            ...
            <form action=""  wire:submit.prevent='store' class="vstack gap-2" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                        <div class="form-floating">
                            ...
                            <label for="floatingadresse">Adresse <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                        <div class="form-floating">
                            ...
                            <label for="floatingnom_tuteur">Nom du tuteur <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                        <div class="form-floating">
                            ...
                            <label for="floatingtelephone_tuteur">Numero du tuteur <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                        <div class="form-floating">
                            <select wire:model="annee_universitaire_id" id="annee_universitaire_id" class="form-control @error('annee_universitaire_id') is-invalid @enderror">
                                <option value="0">Sélectionner une annee_universitaire</option>
                ...
                <div class="row my-3">
                    <div class="card text-center my-3 py-3 surete">
                        ...
                        <i><span>Verifiez s'il n'y a pas d'erreur avant de cliquer sur valider; sinon en cas d'erreur veillez contacter l'administrateur pour vous aidez</span></i>
                    </div>
                    <div class="d-flex flex-row gap-2">
                        <button type="submit" class="btn btn-primary fw-bold fs-6"><i class="bi bi-save me-1"></i> Validez la réinscription</button>
                        <button wire:click='cancel' class="btn btn-danger fw-bold fs-6"><i class="bi bi-eraser me-1"></i>Annuler la réinscription</button>
                    </div>
                </div>
            </form>
