...
<!-- Mirrored from techzaa.getappui.com/velonic/layouts/pages-starter.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 13:19:34 GMT -->

<head>
    <meta charset="utf-8" />
    <title>@yield('title') | ENT-ISTM</title>
    ...
    <link href="{{ asset('backend/fontawesome/css/all.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- Coustom css -->
    <link href="{{asset('backend/css/coustom.css')}}" rel="stylesheet" type="text/css" />
</head>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/images/users/avatar-3.jpg')}}" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 text-truncate ms-2">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="notify-icon">
                                                <img src="{{ asset('backend/images/users/avatar-5.jpg')}}" class="img-fluid rounded-circle" alt="" />
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 text-truncate ms-2">
